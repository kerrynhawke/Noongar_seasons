...
sig_file = "/data2/Kerryn/AGCD_Clim_Sarah_Sapsford_Paper/mask_prop_season_significance_masked.nc"
...
fig.suptitle("Proportional change in seasonal rainfall", fontsize=14, y=0.95)
