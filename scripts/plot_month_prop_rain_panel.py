...
sig_file = "mask_prop_month_significance_masked.nc"
...
## Title
#fig.suptitle("Proportional change in monthly rainfall", fontsize=18, y=0.92)
...
# Save figure
# ---------------------------------------------------------
output_file = os.path.join(output_dir, "prop_change_monthly_rainfall.png")
