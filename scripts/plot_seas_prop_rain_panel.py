...
precip_file = "masked_prop_change_1993_2022_minus_1961_1990.nc"
sig_file = "mask_prop_season_significance_masked.nc"
...
## Title
#fig.suptitle("Proportional change in seasonal rainfall", fontsize=18, y=0.92)
...
cbar.set_label("% change relative to 1961–1990", fontsize=12)

# ---------------------------------------------------------
# Save figure
# ---------------------------------------------------------
output_file = os.path.join(output_dir, "prop_change_seasonal_rainfall.png")
